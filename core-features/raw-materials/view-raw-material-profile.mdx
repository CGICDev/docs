---
title: "View Raw Material Profile"
...
- **Details**  
  ...
  View and edit the name, code, group, UOMs, and description.

- **Inventory**  

  Check shelf life, end-of-life date, valuation method, default warehouse, and barcode mappings.

- **Purchasing**  

  See supplier list, lead times, purchase UOMs, and last purchase rates.

- **Accounting**  

  Review valuation method, expense account, stock adjustment account, and tax rules.

- **BOM**  

  (If used in recipes) View or add Bills of Materials that include this raw material.

- **Dashboard**  

  Monitor current stock balance, recent stock movements, and reorder alerts for the material.
