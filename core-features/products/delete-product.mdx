...
4. **Confirm Deletion**
   ...
   ![Screenshot showing how to delete products](/Screenshot2025-05-14at9.18.42AM.png)

   <Note>
     **Permanent**: Deleting an item cannot be undone. If you might need the item later, consider disabling it instead.
   </Note>
   <Note>
     **Dependencies**: CGIC App will block deletion if the item is used in open transactions (e.g., sales orders, purchase invoices). Close or cancel those first.
   </Note>
